...
if (isset($_POST['btn-mostrar-grafico'])) {
    if (is_numeric($_POST['mostrar-grafico']) && (is_numeric($_POST['definir-hora']))) {
        ...
        echo "<script type='text/javascript'>alert('Os valores introduzidos não são numéricos.');window.location.href='../index.php'</script>";
    }
}
?>
